...
while run:
    ...
    control_object(itemvel, 197,coneposition,CONE)
    if boosttimer <= 0:
        control_object(itemvel, 677,ballposition,BALL)
        
    control_object(itemvel, 487,blenderposition,BLENDER)
    control_object(itemvel, 733,coneposition,CONE)
    control_object(itemvel, 823,blenderposition,BLENDER)
    control_object(itemvel, 500, pigposition, PIG)
